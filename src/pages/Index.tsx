            ...
            <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-[216px] pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full">
              <div className="w-full max-w-[937px] lg:w-[937px] flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                <div className="self-stretch rounded-[3px] flex flex-col justify-center items-center gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                  ...
                  <div className="w-full max-w-[506.08px] lg:w-[506.08px] text-center flex justify-center flex-col text-[rgba(55,50,47,0.80)] sm:text-lg md:text-xl leading-[1.4] sm:leading-[1.45] md:leading-[1.5] lg:leading-7 font-sans px-2 sm:px-4 md:px-0 lg:text-lg font-medium text-sm">
                    Узнай правду о наркотиках, проверь свои знания
                    <br className="hidden sm:block" />
                    и помоги другим сделать правильный выбор.
                  </div>
                </div>
              </div>
              ...
              <div className="self-stretch border-t border-[#E0DEDB] border-b border-[#E0DEDB] flex justify-center items-start">
                ...
                <div className="flex-1 px-0 sm:px-2 md:px-0 flex flex-col md:flex-row justify-center items-stretch gap-0">
                  <FeatureCard
                    title="Факты о наркотиках"
                    description="Узнай реальные последствия употребления наркотиков для здоровья, психики и жизни."
                  ...
                  <FeatureCard
                    ...
                    description="Пройди интерактивную викторину и узнай, насколько хорошо ты разбираешься в теме."
                    isActive={activeCard === 1}
                    progress={activeCard === 1 ? progress : 0}
                    onClick={() => handleCardClick(1)}
                  />
                  <FeatureCard
                    title="Как помочь близким"
                    description="Практические советы: как распознать проблему и где найти помощь для себя и близких."
              ...
              <div className="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center">
                <div className="self-stretch px-4 sm:px-6 md:px-24 py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div className="w-full max-w-[586px] px-4 sm:px-6 py-4 sm:py-5 overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4">
                    ...
                    <div className="self-stretch text-center text-[#605A57] text-sm sm:text-base font-normal leading-6 sm:leading-7 font-sans">
                      Каждый год наркотики уносят миллионы жизней.
                      <br className="hidden sm:block" />
                      Знание — первый шаг к защите себя и близких.
                    </div>
                  </div>
                </div>
                ...
                <div className="self-stretch border-[rgba(55,50,47,0.12)] flex justify-center items-start border-t border-b-0">
                  ...
                  <div className="flex-1 grid grid-cols-2 sm:grid-cols-4 md:grid-cols-4 gap-0 border-l border-r border-[rgba(55,50,47,0.12)]">
                    {[
                      { num: "35 млн", label: "употребляют наркотики" },
                      { num: "500 000+", label: "смертей в год" },
                      { num: "15–25", label: "возраст первого употребления" },
                      { num: "80%", label: "начинают с лёгких наркотиков" },
                      { num: "1 из 5", label: "подростков пробовал наркотики" },
                      { num: "10 лет", label: "сокращает жизнь" },
                      { num: "200 млрд $", label: "теряет мировая экономика" },
                      { num: "3 мин", label: "до первого звонка о помощи: 8-800-200-0-200" },
                    ].map((item, index) => (
                      <div
                        key={index}
                        className="h-24 sm:h-32 md:h-36 lg:h-40 flex flex-col justify-center items-center gap-1 border-b border-[rgba(227,226,225,0.5)] border-r border-[#E3E2E1] px-2"
                      >
                        <div className="text-center text-[#37322F] text-lg sm:text-2xl md:text-3xl font-bold leading-tight font-serif">
                          {item.num}
                        </div>
                        <div className="text-center text-[#605A57] text-[10px] sm:text-xs md:text-sm font-normal leading-tight font-sans">
                          {item.label}
                        </div>
                      </div>
                    ))}
              ...
              <div className="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center">
                <div className="self-stretch px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div className="w-full max-w-[616px] lg:w-[616px] px-4 sm:px-6 py-4 sm:py-5 overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4">
                    ...
                    <div className="self-stretch text-center text-[#605A57] text-sm sm:text-base font-normal leading-6 sm:leading-7 font-sans">
                      Честная информация, интерактивная игра и реальная помощь —
                      <br />
                      всё для того, чтобы сделать правильный выбор.
                    </div>
                  </div>
                </div>
                    ...
                    <div className="border-b border-r-0 md:border-r border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="flex flex-col gap-2">
                        <h3 className="text-[#37322F] text-lg sm:text-xl font-semibold leading-tight font-sans">
                          Знай факты. Защити себя.
                        </h3>
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Вся информация о видах наркотиков, их последствиях и признаках зависимости — в одном месте.
                        </p>
                      </div>
                    ...
                    <div className="border-b border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="flex flex-col gap-2">
                        <h3 className="text-[#37322F] font-semibold leading-tight font-sans text-lg sm:text-xl">
                          Поговори. Помоги. Действуй.
                        </h3>
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Если ты или твой близкий в беде — не молчи. Здесь ты найдёшь, куда обратиться за помощью.
                        </p>
                      </div>
